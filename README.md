...
Projekt slouží jako interaktivní nástroj podporující rozhodování při **nákupu nebo prodeji vozidla**.
...
- **Analýza průměrné ceny podle značky**  
  Srovnání cen a trendů mezi jednotlivými výrobci.

- **Vliv stáří a nájezdu na cenu**  
  Interaktivní filtry pro analýzu dekád a rozsahů nájezdu.

- **Konfigurace pro nákup / prodej**  
  Filtrování podle převodovky, paliva a technického stavu vozidla.

## Insighty z analýzy
- Prémiové značky jako **BMW** a **Mercedes-Benz** mají nejvyšší průměrné ceny.
- Cena vozidla výrazně klesá s vyšším stářím a nájezdem.
